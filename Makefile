...
ifeq ($(CONFIG_OPPO_TARGET_DEVICE),MSM_14042)
KBUILD_CFLAGS += -DOPPO_CU_TEST
endif
ifneq ($(filter $(CONFIG_OPPO_TARGET_DEVICE),MSM_14037 MSM_14039 MSM_14040 MSM_14065),)
