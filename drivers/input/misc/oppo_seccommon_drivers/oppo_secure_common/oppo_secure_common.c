 ...
 **  Wenhao         2024/06/14     port to lineage-19.1, keep only SDM660 path
 ************************************************************************************/
...
/* SDM660 OEM secure boot register addresses */
...
static secure_type_t get_secureType(void)
{
    ...
    /* SDM660: read OEM config registers via ioremap */
                ...
                size_t count, loff_t *off)
{
    ...
    /* SDM660: check override register to determine SN binding state */
    void __iomem *oem_config_base;
