...
**    Modify for vooc batt 4.40   */
        ...
        } else if (chip->vooc_fw_type == VOOC_FW_TYPE_STM8S_4400_AVOID_FG_I2C_ERR_3880MAH) {
                chip->firmware_data = Stm8s_fw_data_4400_avoid_fg_i2c_err_3880mah;
                chip->fw_data_count = sizeof(Stm8s_fw_data_4400_avoid_fg_i2c_err_3880mah);
                chip->fw_data_version = Stm8s_fw_data_4400_avoid_fg_i2c_err_3880mah[chip->fw_data_count - 4];
        }
